-- [ +1 Speed Keyboard Escape - WinBlock Routes & CFrames / Waypoints ]
-- Reconstructed readable Lua table of all WinBlock targets and their Vector3 waypoint paths.

local WinBlockRoutes = {
    ["World 1"] = {
        ["1 Win"] = {
